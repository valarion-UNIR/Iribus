...
//     version 1.13.0
//     from Assets/Settings/Controls/InputSystem_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Controls/InputSystem_Actions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @CustomInputSystem: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Restart"",
                    ""type"": ""Button"",
                    ""id"": ""e118817e-63a1-44af-ad05-1af1ff55b1e7"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""3dbd0940-cae6-44cc-8f04-ba35dcaaab70"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""Stacker"",
            ""id"": ""94178557-0d25-4e1d-ac05-79f83c8088f5"",
            ""actions"": [
                {
                    ""name"": ""PutBlock"",
                    ""type"": ""Button"",
                    ""id"": ""979be9c3-7c73-4b60-949a-55d401efa90b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""c4d164c8-22ad-4ca8-937b-009b53f161de"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""beb1f23a-b31c-4681-8800-f55df3b234f7"",
                    ""path"": ""<Gamepad>/buttonSouth"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_DirtAndSteel_Restart = m_DirtAndSteel.FindAction("Restart", throwIfNotFound: true);
        // CrossTheBeaver
        ...
        // Stacker
        m_Stacker = asset.FindActionMap("Stacker", throwIfNotFound: true);
        m_Stacker_PutBlock = m_Stacker.FindAction("PutBlock", throwIfNotFound: true);
    }
    ...
    ~@CustomInputSystem()
    {
        ...
        UnityEngine.Debug.Assert(!m_Stacker.enabled, "This will cause a leak and performance issues, CustomInputSystem.Stacker.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_DirtAndSteel_Restart;
    /// <summary>
    ...
    public struct DirtAndSteelActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "DirtAndSteel/Restart".
        /// </summary>
        public InputAction @Restart => m_Wrapper.m_DirtAndSteel_Restart;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
    ...
    // Stacker
    private readonly InputActionMap m_Stacker;
    private List<IStackerActions> m_StackerActionsCallbackInterfaces = new List<IStackerActions>();
    private readonly InputAction m_Stacker_PutBlock;
    /// <summary>
    /// Provides access to input actions defined in input action map "Stacker".
    /// </summary>
    public struct StackerActions
    {
        private @CustomInputSystem m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public StackerActions(@CustomInputSystem wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Stacker/PutBlock".
        /// </summary>
        public InputAction @PutBlock => m_Wrapper.m_Stacker_PutBlock;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Stacker; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="StackerActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(StackerActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="StackerActions" />
        public void AddCallbacks(IStackerActions instance)
        {
            if (instance == null || m_Wrapper.m_StackerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_StackerActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="StackerActions" />
        private void UnregisterCallbacks(IStackerActions instance)
        {
            @PutBlock.started -= instance.OnPutBlock;
            @PutBlock.performed -= instance.OnPutBlock;
            @PutBlock.canceled -= instance.OnPutBlock;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="StackerActions.UnregisterCallbacks(IStackerActions)" />.
        /// </summary>
        /// <seealso cref="StackerActions.UnregisterCallbacks(IStackerActions)" />
        public void RemoveCallbacks(IStackerActions instance)
        {
            if (m_Wrapper.m_StackerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="StackerActions.AddCallbacks(IStackerActions)" />
        /// <seealso cref="StackerActions.RemoveCallbacks(IStackerActions)" />
        /// <seealso cref="StackerActions.UnregisterCallbacks(IStackerActions)" />
        public void SetCallbacks(IStackerActions instance)
        {
            foreach (var item in m_Wrapper.m_StackerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_StackerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="StackerActions" /> instance referencing this action map.
    /// </summary>
    public StackerActions @Stacker => new StackerActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Stacker" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="StackerActions.AddCallbacks(IStackerActions)" />
    /// <seealso cref="StackerActions.RemoveCallbacks(IStackerActions)" />
    public interface IStackerActions
    {
        /// <summary>
        /// Method invoked when associated input action "PutBlock" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
